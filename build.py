...
Version: %s
Architecture: %s
Maintainer: rustdesk <info@quickdesk.org>
Homepage: https://quickdesk.org
...
def build_flutter_dmg(version, features):
    ...
    '''
    system2(
        "create-dmg --volname \"QuickDesk Installer\" --window-pos 200 120 --window-size 800 400 --icon-size 100 --app-drop-link 600 185 --icon RustDesk.app 200 190 --hide-extension RustDesk.app rustdesk.dmg ./build/macos/Build/Products/Release/RustDesk.app")
