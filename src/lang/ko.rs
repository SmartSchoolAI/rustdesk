...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비 완료"),
        ("Established", "연결됨"),
        ("connecting_status", "QuickDesk 네트워크에 연결 중..."),
        ...
        ("android_input_permission_tip2", "다음 시스템 설정 페이지로 이동하여 [설치된 서비스]를 찾아 들어가서 [QuickDesk 입력] 서비스를 켜세요."),
        ...
        ("Turned off", "꺼짐"),
        ("Language", "언어"),
        ("Keep QuickDesk background service", "QuickDesk 백그라운드 서비스 유지"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시"),
        ("android_open_battery_optimizations_tip", "이 기능을 비활성화하려면 다음 QuickDesk 응용 프로그램 설정 페이지로 이동하여 [배터리]를 찾아서 입력하고 [제한 없음]을 선택 취소하세요"),
        ...
        ("verify_rustdesk_password_tip", "QuickDesk 비밀번호 확인"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "QuickDesk Server Pro를 {} 버전 이상으로 업그레이드하세요!"),
        ...
        ("allow-only-conn-window-open-tip", "QuickDesk 창이 열려 있을 때만 연결 허용"),
        ...
        ("floating_window_tip", "QuickDesk 백그라운드 서비스를 유지하는 데 도움이 됩니다"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "QuickDesk 클라이언트를 원격 버전 {} 이상으로 업그레이드해 주세요!"),
