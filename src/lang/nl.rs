...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het QuickDesk netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer QuickDesk op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u QuickDesk toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u QuickDesk toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u QuickDesk toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [QuickDesk Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep QuickDesk background service", "QuickDesk achtergronddienst behouden"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u QuickDesk toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u QuickDesk toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende QuickDesk."),
        ...
        ("verify_rustdesk_password_tip", "Bevestiging wachtwoord QuickDesk"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om QuickDesk te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Upgrade QuickDesk Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor QuickDesk mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het QuickDesk-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt QuickDesk op de achtergrond actief te houden"),
        ...
        ("About QuickDesk", "Over QuickDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgrade de QuickDesk client naar versie {} of nieuwer op de externe computer!"),
