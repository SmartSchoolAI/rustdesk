...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete QuickDesk..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), QuickDesk diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare QuickDesk a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a QuickDesk su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a QuickDesk su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a QuickDesk de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada QuickDesk]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep QuickDesk background service", "Mantene su servìtziu de QuickDesk in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione QuickDesk, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show QuickDesk", "Mustra QuickDesk"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a QuickDesk sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a QuickDesk."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de QuickDesk."),
        ...
        ("verify_rustdesk_password_tip", "Cunfirma sa crae de QuickDesk"),
        ...
        ("Exit", "Essi dae QuickDesk"),
        ("Open", "Aberi QuickDesk"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare QuickDesk e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualiza QuickDesk Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de QuickDesk comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae QuickDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana QuickDesk est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de QuickDesk"),
        ...
        ("About QuickDesk", "Informatziones subra de QuickDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualiza su cliente QuickDesk remotu a sa versione {} o prus noa!"),
