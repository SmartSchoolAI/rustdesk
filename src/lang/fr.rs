...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établie"),
        ("connecting_status", "Connexion au réseau QuickDesk…"),
        ...
        ("install_tip", "QuickDesk n’est pas installé, ce qui peut limiter son utilisation à cause de l’UAC. Cliquez ci-dessous pour l’installer."),
        ...
        ("android_input_permission_tip1", "Pour qu’un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher d’écran, vous devez autoriser QuickDesk à utiliser le service « Accessibilité »."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, puis recherchez et accédez à la section [Services installés] ; activez ensuite le service [QuickDesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep QuickDesk background service", "Garder le service QuickDesk en arrière plan"),
        ("Ignore Battery Optimizations", "Ignorer les optimisations de la batterie"),
        ("android_open_battery_optimizations_tip", "Pour désactiver cette fonctionnalité, veuillez accéder à la page suivante des paramètres de l’application QuickDesk, puis recherchez et accédez à la section [Batterie] ; décochez ensuite l’option [Sans restriction]."),
        ...
        ("Show QuickDesk", "Afficher QuickDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Vous devez accorder à QuickDesk l’autorisation « Surveillance de l’entrée » pour contrôler le bureau distant avec le clavier."),
        ("config_microphone", "Vous devez accorder à QuickDesk l’autorisation « Enregistrer l’audio » pour discuter à distance."),
        ...
        ("still_click_uac_tip", "L’utilisateur distant devra malgré tout confirmer l’UAC de l’instance QuickDesk en cours d’éxécution."),
        ...
        ("verify_rustdesk_password_tip", "Vérifier le mot de passe QuickDesk"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu’un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N’AVEZ PAS CONFIANCE et qui vous a demandé d’utiliser QuickDesk et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Veuillez mettre à jour QuickDesk Server Pro vers la version {} ou une version ultérieure !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher QuickDesk de fonctionner correctement sur la machine contrôlée."),
        ...
        ("powered_by_me", "Utilise la technologie QuickDesk"),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre QuickDesk est ouverte"),
        ...
        ("About QuickDesk", "À propos de QuickDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Veuillez mettre le client QuickDesk distant à jour vers la version {} ou ultérieure !"),
