...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a QuickDesk alkalmazást a számítógépére."),
        ...
        ("android_input_permission_tip1", "Ahhoz, hogy egy távoli eszköz vezérelhesse Android készülékét, engedélyeznie kell a QuickDesk számára a „Hozzáférhetőség” szolgáltatás használatát."),
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [QuickDesk Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep QuickDesk background service", "QuickDesk futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a QuickDesk alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show QuickDesk", "A QuickDesk megjelenítése"),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az „Igen” gombra kell kattintania a QuickDesk UAC ablakában. Kattintson!"),
        ...
        ("verify_rustdesk_password_tip", "QuickDesk jelszó megerősítése"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Frissítse a QuickDesk Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a QuickDesk nem fut megfelelően, mint ellenőrzött."),
        ...
        ("powered_by_me", "Üzemeltető: QuickDesk"),
        ("outgoing_only_desk_tip", "Ez a QuickDesk testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a QuickDesk ablaka nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a QuickDesk a háttérben fut."),
        ...
        ("About QuickDesk", "A QuickDesk névjegye"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Frissítse a QuickDesk klienst {} vagy újabb verziójára a távoli oldalon!"),
