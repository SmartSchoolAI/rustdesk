...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Свързване с QuickDesk мрежата..."),
        ...
        ("install_tip", "Поради UAC, QuickDesk в някои случай не може да работи правилно за отдалечена достъп. За да заобиколите UAC, моля, натиснете копчето по-долу, за да поставите QuickDesk като системна услуга."),
        ("Click to upgrade", "Натиснете, за да надстроите"),
        ("Configure", "Настройване"),
        ("config_acc", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на QuickDesk права от раздел \"Достъпност\"."),
        ("config_screen", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на QuickDesk права от раздел \"Запис на екрана\"."),
        ...
        ("Discovered", "Открит"),
        ("install_daemon_tip", "За зареждане при стартиране на ОС трябва да инсталирате QuickDesk като системна услуга."),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или допир, трябва да разрешите на QuickDesk да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница със системни настройки, намерете и въведете [Installed Services], включете услугата [QuickDesk Input]."),
        ...
        ("Language", "Език"),
        ("Keep QuickDesk background service", "Запази QuickDesk фоновата услуга"),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението QuickDesk, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ...
        ("Show QuickDesk", "Покажи QuickDesk"),
        ...
        ("config_input", "За да управлявате отдалечена среда с клавиатура, трябва да предоставите на QuickDesk право за \"Input Monitoring\"."),
        ("config_microphone", "За да говорите отдалечено, трябва да предоставите на QuickDesk право за \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да натисне върху OK в прозореца на UAC при стартиран QuickDesk."),
        ...
        ("verify_rustdesk_password_tip", "Проверете QuickDesk паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате QuickDesk и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Моля обновете QuickDesk Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на QuickDesk да работи правилно като контролирана страна."),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Моля, надстройте клиента QuickDesk до версия {} или по-нова от отдалечената страна!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
