...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de QuickDesk..."),
        ...
        ("install_tip", "En alguns casos és possible que el QuickDesk no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el QuickDesk al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al QuickDesk els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al QuickDesk els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al QuickDesk l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «QuickDesk Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep QuickDesk background service", "Manté el servei del QuickDesk en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del QuickDesk, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("Show QuickDesk", "Mostra el QuickDesk"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al QuickDesk els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al QuickDesk els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del QuickDesk en execució."),
        ...
        ("verify_rustdesk_password_tip", "Verifica la contrasenya del QuickDesk"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del QuickDesk, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualitzeu el QuickDesk Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el QuickDesk funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de QuickDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del QuickDesk està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del QuickDesk en rerefons"),
        ...
        ("About QuickDesk", "Quant al QuickDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Veuillez mettre à niveau le client QuickDesk vers la version {} ou plus récente du côté distant !"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
