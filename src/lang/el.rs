...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο QuickDesk..."),
        ...
        ("install_tip", "Λόγω UAC, το QuickDesk ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το QuickDesk στο σύστημα"),
        ("Click to upgrade", "Αναβάθμιση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για τον απομακρυσμένο έλεγχο του υπολογιστή σας, πρέπει να εκχωρήσετε δικαιώματα πρόσβασης στο QuickDesk."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στον υπολογιστή σας, πρέπει να εκχωρήσετε το δικαίωμα QuickDesk \"Screen Capture\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο QuickDesk να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλώ μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος QuickDesk]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep QuickDesk background service", "Εκτέλεση του QuickDesk στο παρασκήνιο"),
        ...
        ("Show QuickDesk", "Εμφάνιση QuickDesk"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με πληκτρολόγιο, πρέπει να εκχωρήσετε δικαιώματα στο QuickDesk"),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο OK στο παράθυρο UAC όπου εκτελείται το QuickDesk."),
        ...
        ("verify_rustdesk_password_tip", "Επιβεβαιώστε τον κωδικό του QuickDesk"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το QuickDesk, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον QuickDesk Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Έχετε ενεργοποιημένο το SELinux, το οποίο πιθανόν εμποδίζει την ορθή λειτουργία του QuickDesk."),
        ...
        ("powered_by_me", "Με την υποστήριξη της QuickDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο QuickDesk είναι ανοιχτό"),
        ...
        ("About QuickDesk", "Πληροφορίες για το QuickDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Αναβαθμίστε τον πελάτη QuickDesk στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
