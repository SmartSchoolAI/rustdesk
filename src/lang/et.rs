...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa QuickDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et QuickDesk oma süsteemi paigaldada."),
        ...
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [QuickDesk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep QuickDesk background service", "Säilita RustDeski taustateenus"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda QuickDesk Server Pro versioonile {} või uuem!"),
        ...
        ("About QuickDesk", "RustDeski teave"),
