...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "QuickDesk ქსელთან დაკავშირება..."),
        ...
        ("install_tip", "ზოგიერთ შემთხვევაში UAC-ის გამო QuickDesk შეიძლება არასწორად მუშაობდეს დაშორებულ კვანძზე. UAC-თან დაკავშირებული პრობლემების თავიდან ასაცილებლად დააჭირეთ ქვემოთ მოცემულ ღილაკს სისტემაში QuickDesk-ის დასაყენებლად."),
        ("Click to upgrade", "დააჭირეთ განახლებისთვის"),
        ("Configure", "კონფიგურაცია"),
        ("config_acc", "თქვენი სამუშაო მაგიდის დისტანციური მართვისთვის უნდა მიანიჭოთ QuickDesk-ს \"წვდომის\" უფლებები"),
        ("config_screen", "სამუშაო მაგიდაზე დისტანციური წვდომისთვის უნდა მიანიჭოთ QuickDesk-ს \"ეკრანის ანაბეჭდის\" უფლებები"),
        ...
        ("android_input_permission_tip1", "იმისთვის, რომ დაშორებულმა მოწყობილობამ შეძლოს თქვენი Android-მოწყობილობის მართვა თაგუნათი ან შეხებით, საჭიროა QuickDesk-ისთვის \"სპეციალური შესაძლებლობების\" სერვისის გამოყენების უფლების მინიჭება."),
        ("android_input_permission_tip2", "გადადით სისტემის პარამეტრების შესაბამის გვერდზე, იპოვეთ და შედით \"დაინსტალირებულ სერვისებში\", ჩართეთ \"QuickDesk Input\" სერვისი."),
        ...
        ("Language", "ენა"),
        ("Keep QuickDesk background service", "QuickDesk-ის ფონური სერვისის შენარჩუნება"),
        ...
        ("Show QuickDesk", "QuickDesk-ის ჩვენება"),
        ...
        ("config_input", "დისტანციური სამუშაო მაგიდის კლავიატურით სამართავად, საჭიროა QuickDesk-ისთვის \"შეყვანის მონიტორინგის\" უფლების მინიჭება."),
        ("config_microphone", "დისტანციურ მხარესთან სასაუბროდ, საჭიროა QuickDesk-ისთვის \"აუდიოს ჩაწერის\" უფლების მინიჭება."),
        ...
        ("still_click_uac_tip", "კვლავ საჭიროა, რომ დისტანციურმა მომხმარებელმა დააჭიროს \"OK\"-ს UAC ფანჯარაში QuickDesk-ის გაშვებისას."),
        ...
        ("verify_rustdesk_password_tip", "დაადასტურეთ QuickDesk-ის პაროლი"),
        ...
        ("scam_text1", "თუ ტელეფონით ესაუბრებით ვინმეს, ვისაც არ იცნობთ და არ ენდობით, და ის გთხოვთ გამოიყენოთ QuickDesk და გაუშვათ მისი სერვისი, არ გააგრძელოთ და დაუყოვნებლივ შეწყვიტეთ საუბარი."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "განაახლეთ QuickDesk Server Pro ვერსიამდე {} ან უფრო ახალი!"),
        ...
        ("selinux_tip", "თქვენს მოწყობილობაზე ჩართულია SELinux, რამაც შეიძლება ხელი შეუშალოს QuickDesk-ის სწორ მუშაობას მართულ მხარეზე."),
        ("Change view", "ხედი"),
        ...
        ("powered_by_me", "QuickDesk-ზე დაფუძნებული"),
        ...
        ("allow-only-conn-window-open-tip", "დაშვება მხოლოდ მაშინ, როცა QuickDesk-ის ფანჯარა გახსნილია"),
        ...
        ("floating_window_tip", "ეხმარება QuickDesk-ის ფონური სერვისის შენარჩუნებას"),
        ...
        ("About QuickDesk", "QuickDesk-ის შესახებ"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "განაახლეთ QuickDesk კლიენტი ვერსიამდე {} ან უფრო ახალი დისტანციურ მხარეზე!"),
